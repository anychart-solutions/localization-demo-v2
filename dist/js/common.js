(function () {
  ...
  function displayLocaleJSON(code) {
    var $lang = $('#locale-json').find('.language-json');

    console.log(code, window.anychart.format.locales[code]);
    $lang.text(JSON.stringify(window.anychart.format.locales[code], '\n', 2));
